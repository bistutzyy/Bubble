...
public class StarServiceImpl implements StarService {
	...
	public StarList createStars() {
		...
		starList.add(new Star(new Position(1,1),StarType.RED));
		starList.add(new Star(new Position(2,2),StarType.YELLOW));
		starList.add(new Star(new Position(3,3),StarType.GREEN));
		starList.add(new Star(new Position(4,4),StarType.PURPLE));
